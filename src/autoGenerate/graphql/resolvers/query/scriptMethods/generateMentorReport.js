...
const generateMentorReport = async () => {
  ...
  while (totalLoopDays > 0) {
    let mentorReportsObj = {};
    totalLoopDays = totalLoopDays - 1;
    ...
    for (const mentorMenteeSession of mentorMenteeSessions) {
      ...
      if (mentorReportsObj[`${mentorIdInMentorMenteeSession}`]) {
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].bookingsAssigned = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].bookingsAssigned + bookingsAssigned;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].bookingsRescheduled = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].bookingsRescheduled + bookingsRescheduled;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].formFilled = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].formFilled + formFilled;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].sessionLinkUploaded = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].sessionLinkUploaded + sessionLinkUploaded;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].trialsCompleted = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].trialsCompleted + trialsCompleted;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].unfit = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].unfit + unfit;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].lost = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].lost + lost;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].cold = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].cold + cold;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pipeline = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pipeline + pipeline;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].hot = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].hot + hot;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].won = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].won + won;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].oneToOneConversion = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].oneToOneConversion + oneToOneConversion;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].oneToTwoConversion = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].oneToTwoConversion + oneToTwoConversion;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].oneToThreeConversion = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].oneToThreeConversion + oneToThreeConversion;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating1 = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating1 + pythonCourseRating1;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating2 = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating2 + pythonCourseRating2;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating3 = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating3 + pythonCourseRating3;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating4 = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating4 + pythonCourseRating4;
        mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating5 = 
          mentorReportsObj[`${mentorIdInMentorMenteeSession}`].pythonCourseRating5 + pythonCourseRating5;
      } else {
    ...
    for (const mentorSession of mentorSessions) {
      ...
      if (mentorReportsObj[`${mentorIdInMentorSession}`]) {
        mentorReportsObj[`${mentorIdInMentorSession}`].slotsOpened = 
          mentorReportsObj[`${mentorIdInMentorSession}`].slotsOpened + slotsOpened;
      } else {
    ...
    for(const mentorId in mentorReportsObj){
      ...
      if (mentorReportId) {
        ...
        const updateMentorReportQueryRes = await callLocalGraphqlApi(updateMentorReportQuery(
          mentorReportId,
        ...
        // eslint-disable-next-line no-await-in-loop
        const addMentorReportQueryRes = await callLocalGraphqlApi(addMentorReportQuery(
          mentorId,
          endDate,
          mentorReportsObj[`${mentorId}`].slotsOpened,
          mentorReportsObj[`${mentorId}`].bookingsAssigned,
