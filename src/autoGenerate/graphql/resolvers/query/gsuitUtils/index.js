...
export default {
    gsuitCreateFileOrFolder, gsuitUpdatePermissionOfFileOrFolder, gsuitUpdateParentFolderOfFileOrFolder, gsuitDuplicateFileOrFolder, gsuitDeleteFileOrFolder, gsuitGettingChildFileOrFolder,
};
