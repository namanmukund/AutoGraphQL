...
const getSubmittedAssignmentsStudents = async (
  ...
  const UserBlockBasedPracticePipeline = new AggregationBuilder('UserBlockBasedPractice')
    .Project(OnlyPayload('id', 'user', 'blockBasedPractice', 'evaluation', 'topic', 'course', 'answerLink', 'savedBlocks', 'attachments', 'updatedAt'))
    .Match({ 'user.typeId': { $in: userIds }, 'topic.typeId': topicId, 'course.typeId': courseId })
    ...
    .Project({
      ...OnlyPayload('id', 'user', 'topic', 'course', 'answerLink', 'savedBlocks', 'attachments', 'updatedAt'),
