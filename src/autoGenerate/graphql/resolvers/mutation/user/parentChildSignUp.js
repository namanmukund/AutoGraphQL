  ...
  if (fromEventsPage) {
    ...
    setTimeout(() => {
      updateLeadSquared({
        ...
        mx_Event_Date: utmSource.includes('SpySquadCamp') || utmSource.includes('communityevent') ? '11 December' : '19 December',
        mx_Event_Time: utmSource.includes('SpySquadCamp') || utmSource.includes('communityevent') ? '03:00 pm' : '11:00 am',
        mx_Event_Date_Time: utmSource.includes('SpySquadCamp') || utmSource.includes('communityevent') ? '2021-12-11 09:30:00' : '2021-19-05 05:30:00',
      }, false, {
        ActivityEvent: 208,
        Fields: [
          {
