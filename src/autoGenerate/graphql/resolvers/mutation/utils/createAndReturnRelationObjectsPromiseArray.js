...
const createAndReturnRelationObjectsPromiseArray = (relationFieldsArray,
  ...
  const promiseArray = relationFieldsArray.map((fieldObject) => {
    ...
    return createAndReturnRelationObject(fieldName, fieldValue,
      fieldType, relationName, typeName, ast, authentication, context);
  });
  return promiseArray;
};
