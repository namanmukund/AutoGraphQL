const customMutationString = `
   ...
   parentChildSignUp ( schoolId: ID, campaignId: ID, input: ParentChildSignUpInput, bookingAgentId: ID, academicYearId: ID ): ParentChildToken,
   ...
   addUpdateBulkSchoolUserData (sheetId: String, schoolName: String!, setPassword: Boolean, booking: Boolean, academicYearId: ID): AddUpdateBulkSchoolUserDataOutput,
