...
const updateCampaignPostHookMethod = async (input, params, mutationName, context) => {
  ...
  } else if (type === campaignTypes.b2b2cEvent && status === batchCreationStatus.todo) {
    createB2B2CEventBatchesBasedOnBatchRules(campaignId, courseId, batchRules, timeTableRules, classesConnectIds);
  }
};
