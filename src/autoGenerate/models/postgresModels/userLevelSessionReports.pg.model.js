...
const UserLevelSessionReport = sequelize.define(
  'UserLevelSessionReport',
  {
    ...
    videosVisitedScore: { type: DataTypes.INTEGER, allowNull: true },
    ...
    codingAssignmentsAttemptedScore: { type: DataTypes.INTEGER, allowNull: true },
    practicesCount: { type: DataTypes.INTEGER, allowNull: true },
    practicesAttemptedCount: { type: DataTypes.INTEGER, allowNull: true },
    practicesAttemptedScore: { type: DataTypes.INTEGER, allowNull: true },
  },
  {
    sequelize,
    isPgModel: true,
