...
const MENTOR = 'mentor';
const TEACHER_TRAINER = 'teacherTrainer';
const MENTEE = 'mentee';
const PARENT = 'parent';
...
const SUPPLY_DEMAND_ADMIN = 'supplyDemandAdmin';
...
const NOT_UMS_HEAD_ARR = [
  CMS_ADMIN, SELF_LEARNER, SCHOOL_STUDENT, MENTOR, TEACHER_TRAINER, MENTEE, PARENT,
  UMS_VIEWER, CMS_UMS_VIEWER, AFFILIATE, SALES, SALES_EXECUTIVE, TRANSFORMATION_TEAM, TRANSFORMATION_ADMIN, SENSEI,
];
...
const BATCH_HEAD_ARR = [ADMIN, UMS_ADMIN, MENTOR, TEACHER_TRAINER, SALES_EXECUTIVE, SENSEI];
...
const SUPPLY_DEMAND_ROLES_ARRAY = [
  DEMAND_MANAGER, SUPPLY_MANAGER, SUPPLY_DEMAND_ADMIN,
];
